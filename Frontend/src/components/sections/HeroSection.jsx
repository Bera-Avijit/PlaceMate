...
/* ─── Revolving AI Orb ─── */
const orbitItems = [
  { icon: FileSearch, label: "OCR", angle: 0, color: "from-amber-500/20 to-amber-500/5" },
  { icon: Code2, label: "DSA", angle: 90, color: "from-orange-500/20 to-orange-500/5" },
  { icon: Target, label: "MATCH", angle: 180, color: "from-yellow-500/20 to-yellow-500/5" },
  { icon: Workflow, label: "FLOW", angle: 270, color: "from-amber-600/20 to-amber-600/5" },
];
  ...
  return (
    <div className="relative w-[320px] h-[320px] flex items-center justify-center">
      ...
      >
        ...
        <span className="text-[8px] font-black tracking-[0.35em] text-amber-500 uppercase relative z-10">
          AI Core
        </span>
      </motion.div>
  ...
  >
    ...
    <div>
      <p className="text-lg font-black text-white leading-none">
        <Counter to={value} suffix={value >= 1000 ? "+" : "+"} />
      </p>
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#080808]">
      ...
      <div className="relative z-10 max-w-7xl w-full mx-auto px-6 lg:px-12 py-24 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <h1 className="text-[72px] lg:text-[88px] font-black leading-[0.88] tracking-[-0.04em] text-white">
              <span
                ...
                style={{ WebkitTextFillColor: "transparent", WebkitTextStroke: "1px rgba(245,158,11,0.6)" }}
              >
                Target.
              </span>
        ...
        >
          ...
          {/* Feature cards row below orb */}
          <div className="grid grid-cols-2 gap-3 w-full max-w-[340px]">
            {[
              { icon: Code2, title: "DSA Practice", desc: "500+ curated problems", color: "amber" },
              { icon: Target, title: "Mock Drives", desc: "Real company patterns", color: "orange" },
              { icon: Brain, title: "AI Feedback", desc: "Instant code review", color: "yellow" },
              { icon: TrendingUp, title: "Progress Track", desc: "Visual growth map", color: "amber" },
            ].map((card, i) => (
              <motion.div
                key={i}
